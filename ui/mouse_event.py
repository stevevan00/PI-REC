...
class GraphicsScene(QGraphicsScene):
    def __init__(self, mode_list, sketch, parent=None):
    ...
    def drawMask(self, prev_pt, curr_pt):
        ...
        lineItem.setPen(QPen(Qt.black, 4, Qt.SolidLine)) # rect
        self.addItem(lineItem)
        
    def drawSketch(self, prev_pt, curr_pt):
        lineItem = QGraphicsLineItem(QLineF(prev_pt, curr_pt))
        lineItem.setPen(QPen(Qt.white, 1, Qt.SolidLine)) # rect
        self.addItem(lineItem)
        
    def drawStroke(self, prev_pt, curr_pt):
        lineItem = QGraphicsLineItem(QLineF(prev_pt, curr_pt))
        lineItem.setPen(QPen(QColor(self.stk_color), self.pen_thickness, Qt.SolidLine)) # rect
        self.addItem(lineItem)
    ...
    def decrease_thickness(self):
        self.pen_thickness = 1 if self.pen_thickness == 1 else self.pen_thickness - 1
